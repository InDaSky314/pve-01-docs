...
- [ ] **295 SYNTH-only channels remain** (real REAL/SYNTH/PPV breakdown:
      384/295/317 of 996, corrected 2026-07-21 — the old "39 channels"
      figure only checked for ≥1 programme, which the dummy-filler
      fallback always satisfies). Highest-confidence next block: ~25 more
      Bally Sports regional variants have real listings in
      `epg_ripper_FANDUEL1.xml.gz` under renamed "FanDuel Sports Network
      …" entries, same pattern as the Wisconsin fix — likely the single
