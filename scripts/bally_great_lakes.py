...
TARGET_TEAM_ID = 114  # Cleveland Guardians
CHANNEL_ID = "scraped.bally.greatlakes"
DISPLAY_NAME = "Bally Sports Great Lakes"
DAYS_TO_FETCH = 7
  ...
  if not events:
    ...
    for d in range(DAYS_TO_FETCH):
      ...
      events.append({
          "start": day_start,
          "stop": day_stop,
          "title": f"{DISPLAY_NAME} Programming",
          "desc": f"No live MLB games scheduled for {DISPLAY_NAME}."
      })
